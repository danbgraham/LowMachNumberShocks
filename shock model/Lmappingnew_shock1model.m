%% Script used to calculate distribution functions for a range of parameters 
% Parameters are varied just below an in the dydt function.
...
save('histstruct_shock1_l5_Bn25.mat','histstruct')
